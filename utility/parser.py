...
def parser():
    ...
    parser.add_argument('--pretrain_model_path', nargs='?', default='result/KGAT/last-fm/entitydim64_relationdim64_bi-interaction_64-32-16_lr0.0001_pretrain1/model_epoch1.pth',
